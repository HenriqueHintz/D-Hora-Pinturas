  ...
  return (
    <footer className="bg-neutral-900 text-neutral-400 pt-16 pb-8 border-t border-neutral-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-neutral-800 text-sm text-center flex flex-col md:flex-row justify-between items-center gap-4">
          <p>&copy; {new Date().getFullYear()} D'Hora Pinturas & Limpezas. Todos os direitos reservados.</p>
          <p>CNPJ: 42.096.334/0001-50</p>
        </div>
      </div>
    </footer>
  );
